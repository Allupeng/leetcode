...
// @lc code=start
    class Solution {
        public boolean canWinNim(int n) {
            // every player using best strategy
            return n % 4 != 0;
        }
    }
// @lc code=end
    ...
    @Test
    public void testCanWinNimWithFiveStones() {
        Solution solution = new Solution();
        assertFalse(solution.canWinNim(5));
    }

    @Test
    public void testCanWinNimWithSixStones() {
        Solution solution = new Solution();
        assertTrue(solution.canWinNim(6));
    }

    @Test
    public void testCanWinNimWithSevenStones() {
        Solution solution = new Solution();
        assertTrue(solution.canWinNim(7));
    }

    @Test
    public void testCanWinNimWithEightStones() {
        Solution solution = new Solution();
        assertTrue(solution.canWinNim(8));
    }
}
